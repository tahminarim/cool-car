...
const Advertise = () => {
        ...
        useEffect(()=>{
            axios.get('https://b612-used-products-resale-server-side-tahminarim.vercel.app/advertise')
            .then(data=> {
                const car= data.data;
                console.log('data in axios',car)
                setCars(car)
        ...
        return (
            <div className='bg-blue-200'>
                ...
                <div className='text-center mb-4 '>
                    <h2 className="text-5xl font-semibold text-blue-500">Advertised Cars</h2>
