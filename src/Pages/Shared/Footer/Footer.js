...
const Footer = () => {
    return (
<footer className="footer footer-center p-5 bg-blue-800 text-primary-content">
  <div>
    <img alt='logo' width="80" height="40" src={logo}    />
    <p className="font-bold">
    COOLCAR  <br/>Providing reliable Car since 2015
    </p> 
    <p>Copyright © 2022 - All right reserved by COOLCAR</p>
  </div> 
  <div>
