...
const DisplayHybridCar = () => {
    ...
    useEffect(() => {
        fetch('https://b612-used-products-resale-server-side-tahminarim.vercel.app/hybridcar')
            .then(res => res.json())
            .then(data => {
                console.log(data)
                setCars(data)})
    ...
    return (
        ...
        <div className='text-center mb-4 '>
            <h2 className="text-5xl font-semibold text-blue-500">Our Hybrid Cars</h2>
...
export default DisplayHybridCar;